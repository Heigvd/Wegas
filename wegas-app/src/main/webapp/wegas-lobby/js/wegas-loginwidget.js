        ...
        renderUI: function() {
            ...
            if (Wegas.Helper.getURLParameter("redirect").indexOf("token") > -1) {// If the user is trying to acces
                ...
                cb.one(".main.left").setContent("<h1>Welcome to Wegas</h1>\n\
                        ...
                        + '<img href="wegas-lobby/images/wegas-proggame-1.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-proggame-2.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-proggame-3.png" style="display:none">'
                        + '</a></span></span></span>'
                        ...
                        + '| <a href="#" class="wegas-light-gallery" >Screenshots'
                        + '<img href="wegas-lobby/images/wegas-leaderway-1.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-leaderway-2.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-leaderway-3.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-leaderway-4.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-leaderway-6.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-leaderway-7.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-leaderway-8.png" style="display:none">'
                        + '</a></span></span></span>'
                        ...
                        + '| <a href="#" class="wegas-light-gallery" >Screenshots'
                        + '<img href="wegas-lobby/images/wegas-virtualpatient-1.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-virtualpatient-2.png" style="display:none">'
                        + '<img href="wegas-lobby/images/wegas-virtualpatient-3.png" style="display:none">'
                        + '</a></span></span></span>'
