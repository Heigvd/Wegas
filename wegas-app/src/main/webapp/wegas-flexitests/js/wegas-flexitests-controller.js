...
YUI.add("wegas-flexitests-controller", function(Y) {
    ...
    Y.Wegas.FlexitestsController = Y.Base.create("wegas-flexitests-controller",
        Y.Wegas.AbsoluteLayout,
        [Y.Wegas.Editable,
            Y.Wegas.Parent],
        {
            ...
            next: function() {
                ...
                this.mask();
                this.set("currentLoading",
                    {
                        left: true,
                        center: true,
                        right: true
                    });
                this.currentQuestionId = questionId = this.generateNextId();
                this.get("contentBox").get("children").each(function(item) {
                    if (item.hasClass("wegas-choicelist")) {
                        Y.Widget.getByNode(item).set("element", +questionId);
                    }
                });
            ...
            createLoadingEvent: function() {
                if (this.centerElement.getActiveElement() &&
                    this.centerElement.getActiveElement() instanceof Y.Wegas.Image) {
                ...
                if (this.leftElement.getActiveElement() &&
                    this.leftElement.getActiveElement() instanceof Y.Wegas.Image) {
                ...
                if (this.rightElement.getActiveElement() &&
                    this.rightElement.getActiveElement() instanceof Y.Wegas.Image) {
    ...
    Y.Plugin.FlexiResponse = Y.Base.create("wegas-flexi-response",
        Y.Plugin.Base,
        [Y.Wegas.Plugin,
            Y.Wegas.Editable],
        {},
