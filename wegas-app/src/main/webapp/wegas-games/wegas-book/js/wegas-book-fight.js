...
YUI.add("wegas-book-fight", function(Y) {
    ...
    Fight = Y.Base.create("wegas-book-fight", Y.Widget, [Y.WidgetChild, Y.Wegas.Widget, Y.Wegas.Editable], {
        ...
        alternative: null,
        doFight: function(e) {
            var combatSkill = Y.Wegas.Facade.Variable.cache.find("name", "combatSkill"),
                stamina = Y.Wegas.Facade.Variable.cache.find("name", "stamina").
        ...
        setStamina: function(stamina) {
            ...
            Y.Wegas.Facade.Variable.script.run("stamina.value =" + stamina + ";");
        },
