...
export const editorTabsTranslationsDE: EditorTabsTranslations = {
  ...
  fileBrowser: {
    ...
    itemMustName: (item) => `${item ? item : 'Das Element'} muss einen Namen haben.`,
    page: 'Die Seite',
    folder: 'Der Ordner',
  ...
  pageEditor: {
    ...
    firstCompoNotDeleted: 'Die erste Komponente einer Seite darf nicht gelöscht werden',
    ...
    editorMustEnabled: 'Der Bearbeitungsmodus muss aktiviert sein, um die Palette verwenden zu können.',
