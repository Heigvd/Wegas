...
export const editorTabsTranslationsFR: EditorTabsTranslations = {
  ...
  pageEditor: {
    ...
    firstCompoNotDeleted: 'Le premier cpomposant d\'une page ne peut être supprimé',
    ...
    editorMustEnabled: 'Le mode édition doit être activé pour pouvoir utiliser la palette.',
