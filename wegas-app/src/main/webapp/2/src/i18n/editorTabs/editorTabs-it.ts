...
export const editorTabsTranslationsIT: EditorTabsTranslations = {
  ...
  pageEditor: {
    ...
    firstCompoNotDeleted: 'Il primo componente di una pagina non può essere cancellato',
    ...
    editorMustEnabled: 'La modalità di modifica deve essere abilitata per utilizzare la tavolozza.',
