...
interface ImperativeModalsProps {
  /**
   * global - if set true, this modal layout can be used with globalModals everywhere in the code.
   * If used multiple time, it will override previous globalModals.
   */
  global?: boolean;
  /**
   * children - the children element are given modals and disabled
   * modals is the collection of modals offered by the component
   * disabled tells the children if a modal is beeing used right now
   */
  children: (modals?: WModals, disabled?: boolean) => React.ReactNode;
}

export function ImperativeModals(props: ImperativeModalsProps) {
