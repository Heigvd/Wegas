...
import { SPlayer, SWhQuestionDescriptor, SWhQuestionInstance } from 'wegas-ts-api';
...
export class SWhQuestionDescriptorImpl extends SWhQuestionDescriptor {
  ...
  public getInstance(player: Readonly<SPlayer>): Readonly<import("wegas-ts-api").SWhQuestionInstance> {
  ...
  public setFeedback(_p: Readonly<SPlayer>, _value: Readonly<import("wegas-ts-api").STranslatableContent>): void {
    throw Error('This is readonly');
  }
