...
import { SChoiceDescriptorImpl, SSingleResultChoiceDescriptorImpl } from './impl/ChoiceDescriptor';
import { SFSMDescriptorImpl, STriggerDescriptorImpl, SDialogueDescriptorImpl } from './impl/SFSMDescriptor';
...
import { SSurveyChoicesDescriptorImpl, SSurveyTextDescriptorImpl, SSurveyNumberDescriptorImpl } from './impl/SurveyInputDescriptor';
...
export function instantiate<T extends IMergeable | IMergeable[] | MapOf<IMergeable> | null | undefined>(entity: T) {
