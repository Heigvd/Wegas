...
import { StateProcess, TransitionFlowLine } from "../../Editor/Components/StateMachineEditor";
...
export function TransitionBox({ transition, className, selected, onClick }: TransitionBoxProps) {
  ...
  return (
    ...
    onClick= {onClick}>
      ...
      {isShown
      && (transition.transition.preStateImpact.content || transition.transition.triggerCondition.content)
      && (
