...
export type SelectedDropMenuItem<T, MItem extends DropMenuItem<T>> = MItem & {
  path: number[];
  value: Exclude<MItem['value'], undefined>;
};

export interface DropMenuProps<T, MItem extends DropMenuItem<T>> {
  id?: string;
  onSelect: (
    item: SelectedDropMenuItem<T, MItem>,
