    ...
    Y.Wegas.I18n.register("wegas-i18n-survey", "fr", {
        survey: {
            ...
            orchestrator: {
                ...
                scopeTitle: "Les joueurs répondront:",
                ...
                scenarioCreated: "Ce questionnaire est à présent disponible dans le scénario<br>\"{{name}}\".<br>Veuillez rafraîchir l'onglet du browser contenant vos scenarios actuels.",
                sessionCreated: "Ce questionnaire est à présent disponible dans la partie<br>\"{{name}}\".<br>Veuillez rafraîchir l'onglet du browser contenant vos parties actuelles.",
                invitePanel: {
