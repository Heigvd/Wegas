        ...
        survey: {
            ...
            orchestrator: {
                ...
                invitePanel: {
                    ...
                    inviteLiveChoice: "A) to players who already joined the game",
                    inviteListChoice: "B) to an email list<br>(anonymous replies)",
                    inviteLiveAndListChoice: "C) combine (A) with (B) to reach everyone optimally",
                    ...
                    invitedEmails: "Emails of already invited persons",
                    senderName: "Your sender name",
                    liveRecipients: "Emails of current players (updated automatically)",
                    liveRecipientsPlaceholder: "Here will appear the emails of current players",
                    listRecipientsChoiceB: "Your mailing list",
                    listRecipientsChoiceC: "Emails of all course participants",
                    listRecipientsPlaceholder: "Enter one email per line, or separate them with commas, semicolons or spaces.",
                    countEmails: "Count: ",
                    ...
                    anonMailSubject: "[Albasim Wegas] Anonymous survey"
                },
                errors: {
