                ...
                syncUI: function () {
                    ...
                    if (!inboxDescriptor) {
                        ...
                        if (messages.length === 0) {
                            ...
                            var messagesToRemove = Y.mix({}, this.messages);

                            for (var i in messages) {
                                var message = messages[i];
                                if (this.messages[message.get("id")]) {
                                    delete messagesToRemove[message.get("id")];
                            ...
                            for (var i in messagesToRemove) {
                                var toRemove = messagesToRemove[i];
                                Y.log("TO REMOVE: " + toRemove);
