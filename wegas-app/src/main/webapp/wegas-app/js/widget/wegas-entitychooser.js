...
YUI.add("wegas-entitychooser", function(Y) {
    ...
    EntityChooser2 = Y.Base.create("wegas-entitychooser2", Y.Widget,
        ...
        syncUI: function() {
            ...
            this.get("boundingBox").getDOMNode().setAttribute("data-count", counter);
        ...
        selectNextUnread: function() {
            ...
            if (this.currentTarget) {
                ...
                if (!newTarget) {
                    newTarget = this.get("contentBox").one("li");
                }
            }
            if (newTarget) {
    ...
    var ObjectPropertyEditor = Y.Base.create("wegas-objectproperties-editor", Y.Widget,
        [Y.WidgetChild, Y.Wegas.Widget, Y.Wegas.Editable], {
        CONTENT_TEMPLATE:
            "<div>"
            + "  <div class='header'>"
