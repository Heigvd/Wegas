...
YUI.add('wegas-react-form', Y => {
    ...
    const RForm = Y.Base.create(
        ...
        [Y.WidgetChild, Wegas.Widget, Wegas.Editable],
        {
            ...
            renderForm(value: {} | undefined, schema: Schema) {
                if (schema) {
                    ...
                    render(
                        ...
                        >
                            {createPortal(<LangToggler />, this.langSelectorNode)}
            ...
            activateSaveBtn() {
                const ptn =
                    this.get('contentBox')._node && this.get('contentBox').get('parentNode');
                if (!ptn) {
                    return;
                }
                            ...
                            additionalProperties: {
                                ...
                                properties: {
                                    ...
                                    view: {
                                        ...
                                        properties: {
                                            label: {
                                                errored: function requiredString(v: string) {
                                                    if (v && v.trim()) {
                                                        return '';
                                                    }
                                                    return 'is required!';
    ...
    (RForm as any).Script = {
        ...
        register: function r(
            ...
            import(/* webpackChunkName: "reactForm" */ './Script/index').then(({ register }) => {
        ...
        VariableStatement(...args: any[]) {
            return Promise.all([
                import(/* webpackChunkName: "reactForm" */ './Script/index'),
                import(/* webpackChunkName: "reactForm" */ './defaultViews'),
            ]).then(([{ IndependantVariableStatement }]) => IndependantVariableStatement(...args));
        },
    };
