...
export const fr: WegasTranslations = {
  ...
  verified: org => `identité vérifiée (${org})`,
  ...
  agreedTime: "A accepté les conditions d'utilisations le ",
  never: 'jamais',
  ...
  spyGame: "Ouvrir le dashboard de la partie à laquelle l'utilisateur joue",
  //
  sortBy: 'trier par: ',
  createdBy: 'crée par',
  name: 'nom',
  ...
  allGameModels: 'Tous les scénarios',
  uploadGameModel: 'Uploader un scénario',
  createGameModel: 'Créer un scénario',
  ...
  logId: 'Log ID',
  guestAllowed: 'Invités autorisés',
  ...
  pdfTooltip: (gm: IGameModel) =>
    `Le PDF d'un ${fr.prettyPrintType(gm)} liste tout son contenu dans un format imprimable`,
  ...
  noInstances: 'Aucune instance de ce modèle',
  ...
  requestClientReload:
    'Demander aux utilisateurs de recharger la page (p.ex. après une grosse mise à jour)',
  ...
  userLevels: {
    0: 'Administrateurs',
    1: 'Scénaristes/Animateurs',
    2: 'Joueurs',
    3: 'Invités',
    4: 'Role inconnu ???',
  },
  aaiAccount: 'Compte AAI',
  aaiAffiliation: 'Établissement',
