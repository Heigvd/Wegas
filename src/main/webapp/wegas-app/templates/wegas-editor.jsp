...
<html lang="en"> 
    <head>   
        ...
        <link rel="stylesheet" type="text/css" href="wegas-editor/resources/wegas-editor.css" />
       ...
       <script type="text/javascript" src="jquery/jquery.atmosphere.js"></script>-->
        ...
        <script type="text/javascript" >
            ...
            Config = {
                ...
                currentPlayer: 1,
                loggedIn : true,
                css: ['wegas-projectmanagementgame/resources/wegas-projectmanagementgame.css'],
                dataSources: {
                    "GameModel": {
                        source: "rs/GameModel",
                        plugins: [
