 ...
 * @author fx
 */
@ManagedBean(name = "gameEntityController")
@SessionScoped
public class GameEntityController implements Serializable {
    ...
    public static class GameEntityControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            GameEntityController controller = (GameEntityController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof GameEntity) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + GameEntityController.class.getName());
            }
        }
    }
}
