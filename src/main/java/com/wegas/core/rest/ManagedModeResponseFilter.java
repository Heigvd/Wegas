...
public class ManagedModeResponseFilter implements ContainerResponseFilter, ResourceFilter {
    ...
    private static class EntityUpdatedEvent extends ServerEvent {
        ...
        private List<VariableInstanceEntity> updatedEntities;

        public EntityUpdatedEvent() {
        }

        public EntityUpdatedEvent(List<VariableInstanceEntity> updatedEntities) {
         ...
         */
        public void setUpdatedEntities(List<VariableInstanceEntity> updatedEntities) {
            this.updatedEntities = updatedEntities;
        }
    }
}
