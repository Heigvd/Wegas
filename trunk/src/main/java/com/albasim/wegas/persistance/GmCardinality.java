...
public abstract class GmCardinality extends AnonymousAlbaEntity implements Serializable {
    ...
    @XmlTransient
    @NotNull
    private GmVariableDescriptor varDesc;

    @XmlTransient
    public GmVariableDescriptor getVarDesc() {
        return varDesc;
    }


    public void setVarDesc(GmVariableDescriptor varDesc) {
