...
public class GameModel extends NamedEntity implements Serializable {
    ...
    Collection<VariableDescriptorEntity> variableDescriptors;
...
*/
    ...
    @XmlTransient
    public Collection<VariableInstanceEntity> getVariableInstances() {
    ...
    @XmlTransient
    public VariableInstanceEntity lookupVariableInstance(String varName) {
        for (VariableInstanceEntity vi : this.variableInstances) {
    ...
    public boolean isReferencingAnInt(String v, GmComplexType cType) {
        ...
        if (split.length > 0) {
            ...
            VariableDescriptorEntity theVd = null;
...
/*                if (theVd.getCardinality() instanceof GmOneCardinality
     ...
     */
    @XmlTransient
    public GmIntegerInstance resolveIntInstance(VariableInstanceEntity theVar) {
        return null;
/*      
        VariableDescriptorEntity descriptor = theVar.getDescriptor();
