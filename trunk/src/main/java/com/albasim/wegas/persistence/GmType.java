...
import com.albasim.wegas.persistence.type.GmBooleanType;
...
import com.albasim.wegas.persistence.type.GmMediaType;
import com.albasim.wegas.persistence.type.GmStringType;
import com.albasim.wegas.persistence.type.GmTextType;
...
public abstract class GmType extends NamedEntity implements Serializable {
    ...
    @XmlTransient
    private List<VariableDescriptorEntity> descriptors;
    ...
    @XmlTransient
    public List<VariableDescriptorEntity> getDescriptors() {
        return descriptors;
    }


    public void setDescriptors(List<VariableDescriptorEntity> descs) {
    ...
    public abstract GmInstance createInstance(String name, VariableInstanceEntity vi,
                              GmEnumItem aThis);
