...
final public class WFSConfig {
    ...
    /**
     * WeGAS file system namespace prefix for use with XPATH <b>{@value #WeGAS_FILE_SYSTEM_PREFIX}</b>
     */
    ...
    /**
     * WeGAS file system description property name <b>{@value #WFS_DESCRIPTION}</b>
     */
