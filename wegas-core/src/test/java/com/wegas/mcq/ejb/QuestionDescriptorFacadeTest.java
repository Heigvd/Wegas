...
public class QuestionDescriptorFacadeTest extends AbstractArquillianTest {
    ...
    public void testSelectAndCancel() throws NamingException {
        ...
        assertEquals(((ChoiceInstance) variableInstanceFacade.find(choice.getId(), player.getId())).getReplies().size(), 1);
        ...
        assertEquals(((ChoiceInstance) variableInstanceFacade.find(choice.getId(), player.getId())).getReplies().size(), 0);
