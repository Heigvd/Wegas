...
public class StateMachineITest extends AbstractArquillianTest {
    ...
    public void editorUpdate() throws NamingException {
        ...
        requestFacade.getRequestManager().setPlayer(null);
        variableInstanceFacade.update(p0Instance.getId(), p0Instance); // Triggers requestFacade.commit -> StateMachine check
    ...
    public void highScore() throws NamingException, WegasScriptException {
        ...
        requestFacade.getRequestManager().setPlayer(null);
        requestFacade.getRequestManager().setPlayer(player);
