...
public class VariableDescriptorFacadeTest extends AbstractArquillianTest {
    ...
    public <T extends VariableDescriptor> T testVariableDescriptor(T descriptor1, T descriptor2)
        ...
        variableDescriptorFacade.create(gameModel.getId(), descriptor1);
        ...
        // Check edition
        T findByName = (T) variableDescriptorFacade.find(gameModel, VARIABLENAME2);
        ...
        T findByClass = (T) variableDescriptorFacade.findByClass(gameModel, descriptor1.getClass()).get(0);
        Assert.assertEquals(descriptor1.getId(), findByClass.getId());

        // Check the findByGameModel function
        Set<T> findByRootGameModelId = (Set<T>) variableDescriptorFacade.findAll(gameModel.getId());
    ...
    public void testMove2() throws NamingException {
        ...
        variableDescriptorFacade.create(gameModel.getId(), vd1);
        ...
        variableDescriptorFacade.create(gameModel.getId(), vd2);
        gm = gameModelFacade.find(gameModel.getId());
        ...
        List<VariableDescriptor> findByGameModelId = variableDescriptorFacade.findByGameModelId(gameModel.getId());// Refresh
        ...
        variableDescriptorFacade.create(gameModel.getId(), vd3);
        gm = gameModelFacade.find(gameModel.getId());
        ...
        findByGameModelId = variableDescriptorFacade.findByGameModelId(gameModel.getId());           // Refresh
    ...
    public void testMove3P() throws NamingException {
        ...
        variableDescriptorFacade.create(gameModel.getId(), list1);
        gm = gameModelFacade.find(gameModel.getId());
        Assert.assertEquals(1, gm.getVariableDescriptors().size());
        Assert.assertEquals(1, gm.getChildVariableDescriptors().size());
        ...
        List<VariableDescriptor> childrenDescriptors = variableDescriptorFacade.findByGameModelId(gameModel.getId());
        ...
        childrenDescriptors = variableDescriptorFacade.findByGameModelId(gameModel.getId());         // Refresh
        ...
        variableDescriptorFacade.create(gameModel.getId(), list2);
