...
public class VariableDescriptorFacadeTest extends AbstractArquillianTest {
    ...
    public void testNumberDescriptor() throws NamingException, WegasNoResultException {
        ...
        Assertions.assertEquals(VAL2, instance.getValue(), 0.0001);
        ...
        Assertions.assertEquals(VAL3, instance.getValue(), 0.0001);
    ...
    public void testStringDescriptor() throws NamingException, WegasNoResultException {
        ...
        Assertions.assertEquals(VALUE2, instance.getValue());
        ...
        Assertions.assertEquals(VALUE3, instance.getValue());
    ...
    public void testBooleanDescriptor() throws NamingException, WegasNoResultException {
        ...
        Assertions.assertEquals(false, instance.getValue());
        ...
        Assertions.assertEquals(true, instance.getValue());
    ...
    public void testGameModelScope() throws NamingException {
        ...
        Assertions.assertEquals(desc.getId(), variableInstanceFacade.find(desc.getId(), player).getParentId());
    ...
    public <T extends VariableDescriptor> T testVariableDescriptor(T descriptor1, T descriptor2)
        ...
        Assertions.assertEquals(descriptor1.getId(), findByName.getId());
        Assertions.assertEquals(descriptor2.getName(), findByName.getName());

        // Check the findByClass Function
        T findByClass = (T) variableDescriptorFacade.findByClass(scenario, descriptor1.getClass()).get(0);
        Assertions.assertEquals(descriptor1.getId(), findByClass.getId());
        ...
        Assertions.assertTrue(findByRootGameModelId.contains(descriptor1));
    ...
    public void testMove2() throws NamingException {
        ...
        Assertions.assertEquals(1, gm.getChildVariableDescriptors().size());
        Assertions.assertEquals(1, gm.getVariableDescriptors().size());
        ...
        gm = gameModelFacade.find(scenario.getId());
        Assertions.assertEquals(2, gm.getChildVariableDescriptors().size());
        Assertions.assertEquals(2, gm.getVariableDescriptors().size());
        ...
        Assertions.assertEquals(VARIABLENAME, findByGameModelId.get(1).getName());
        ...
        gm = gameModelFacade.find(scenario.getId());
        Assertions.assertEquals(3, gm.getChildVariableDescriptors().size());
        Assertions.assertEquals(3, gm.getVariableDescriptors().size());
        ...
        Assertions.assertEquals(3, gm.getChildVariableDescriptors().size());
        Assertions.assertEquals(4, gm.getVariableDescriptors().size());

        findByGameModelId = variableDescriptorFacade.findByGameModelId(scenario.getId());           // Refresh
        Assertions.assertEquals(SUBNAME1, ((ListDescriptor) findByGameModelId.get(2)).item(0).getName());

        variableDescriptorFacade.move(sub1.getId(), 0);                                              // Move at first position
        gm = gameModelFacade.find(scenario.getId());
        // now, it is:
        Assertions.assertEquals(4, gm.getChildVariableDescriptors().size());
        Assertions.assertEquals(4, gm.getVariableDescriptors().size());

        findByGameModelId = variableDescriptorFacade.findByGameModelId(scenario.getId());           // Refresh
        Assertions.assertEquals(SUBNAME1, findByGameModelId.get(0).getName());
        Assertions.assertEquals(0, ((ListDescriptor) findByGameModelId.get(3)).size());
        ...
        gm = gameModelFacade.find(scenario.getId());
        Assertions.assertEquals(0, gm.getVariableDescriptors().size());
        Assertions.assertEquals(0, gm.getChildVariableDescriptors().size());
    ...
    public void testMove3P() throws NamingException {
        ...
        Assertions.assertEquals(VARIABLENAME1, ((ListDescriptor) childrenDescriptors.get(0)).item(0).getName());// Check if item was successfully added
        gm = gameModelFacade.find(scenario.getId());
        Assertions.assertEquals(3, gm.getVariableDescriptors().size());
        Assertions.assertEquals(1, gm.getChildVariableDescriptors().size());
        ...
        Assertions.assertEquals(VARIABLENAME2, ((ListDescriptor) childrenDescriptors.get(0)).item(0).getName());
        ...
        childrenDescriptors = variableDescriptorFacade.findByGameModelId(scenario.getId());         // Refresh
        Assertions.assertEquals(VARIABLENAME3, ((ListDescriptor) childrenDescriptors.get(0)).item(0).getName());
        Assertions.assertEquals(1, childrenDescriptors.size());
        ...
        childrenDescriptors = variableDescriptorFacade.findByGameModelId(scenario.getId());         // Refresh
        Assertions.assertEquals(VARIABLENAME3, ((ListDescriptor) childrenDescriptors.get(1)).item(0).getName());
        Assertions.assertEquals(2, ((ListDescriptor) childrenDescriptors.get(0)).size());
    ...
    public void testListDuplicate() throws NamingException, CloneNotSupportedException, WegasNoResultException {
        ...
        Assertions.assertEquals(10.0, ((NumberDescriptor) ((DescriptorListI) ((DescriptorListI) duplicate.item(1)).item(0)).item(0)).getInstance(player).getValue(), 0.0001);

        duplicate = (DescriptorListI) variableDescriptorFacade.duplicate(list3.getId());             // Duplicate a sub child variable
        Assertions.assertEquals(10.0, ((NumberDescriptor) ((DescriptorListI) duplicate.item(0)).item(0)).getInstance(player).getValue(), 0.0001);
        ...
        Assertions.assertEquals(10.0, ((NumberInstance) instances.iterator().next()).getValue(), 0.0001);
    }
}
