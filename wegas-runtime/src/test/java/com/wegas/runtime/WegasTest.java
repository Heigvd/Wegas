...
public class WegasTest {
    ...
    public void testStandardProcess() throws IOException {
        ...
        // Get
        Assertions.assertTrue(gameModels.contains(artos));
        ...
        Assertions.assertNull(userTeams);
    ...
    public void testTrainerDeletePlayer() throws IOException {
        ...
        Assertions.assertEquals(1, games.size()); // artos
        ...
        Assertions.assertEquals(1, teams.size()); // myTeam
        List<Player> players = teams.get(0).getPlayers();
        Assertions.assertEquals(1, players.size()); // user
        ...
        Assertions.assertEquals(0, teams.size()); // myTeam
